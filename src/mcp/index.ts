...
// 远程函数注册中心
export type { RemoteFunctionRegistry, RemoteFunctionInfo, RemoteFunctionResult } from './interfaces/RemoteFunctionRegistry.js';
export { RemoteFunctionRegistrySymbol } from './interfaces/RemoteFunctionRegistry.js';
