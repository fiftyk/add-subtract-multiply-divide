...
import type { RemoteFunctionRegistry, RemoteFunctionInfo } from './index.js';
import { RemoteFunctionRegistrySymbol } from './interfaces/RemoteFunctionRegistry.js';
...
export class RemoteToolProvider implements ToolProvider {
  ...
  constructor(
    @inject(RemoteFunctionRegistrySymbol) @optional() private remoteRegistry?: RemoteFunctionRegistry,
