...
import { RemoteFunctionRegistry, RemoteFunctionRegistrySymbol, MCPClient, NoOpRemoteFunctionRegistry } from './mcp/index.js';
...
// 没有配置服务器时使用 NoOp 实现
container.bind<RemoteFunctionRegistry>(RemoteFunctionRegistrySymbol).toDynamicValue(() => {
    const config = ConfigManager.get();
